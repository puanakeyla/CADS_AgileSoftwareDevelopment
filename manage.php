...
<head>
    ...
    <style>
        ...
        button { border: 0; border-radius: 7px; padding: 8px 10px; color: #fff; background: #2563eb; cursor: pointer; }
...
<body>
    <header class="topbar">
        ...
        <span class="chip">Menu: Legacy Manage</span>
